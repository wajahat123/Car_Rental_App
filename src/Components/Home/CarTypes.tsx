...

{
    carTypes.map((car, index) => (
      <div key={index} className='w-full p-4 text-white space-y-1 md:space-y-2 mx-auto hover:text-primary transition-all active:scale-95 duration-500 cursor-pointer group'>
